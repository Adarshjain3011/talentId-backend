...
exports.signupUser = exports.searchUserInfo = exports.resetPassword = exports.logout = exports.loginUser = void 0;
var _dummyDb = require("../db/dummy.db.js");
var _userModel = _interopRequireDefault(require("../models/user.model.js"));
var _bcryptjs = _interopRequireDefault(require("bcryptjs"));
var _generateTokenAndSetCookie = _interopRequireDefault(require("../utils/generateTokenAndSetCookie.js"));
...
var signupUser = exports.signupUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, fullname, email, phone, company, role, password, user, hashedPassword, newUser;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, fullname = _req$body.fullname, email = _req$body.email, phone = _req$body.phone, company = _req$body.company, role = _req$body.role, password = _req$body.password;
        ...
        case 17:
          ...
          console.log("Error in signupUser", _context.t0.message);
        case 21:
        case "end":
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 11:
          (0, _generateTokenAndSetCookie["default"])(user._id, res);
          res.status(201).json({
            _id: user._id,
        ...
        case 15:
          ...
          console.log("Error in loginUser", _context2.t0.message);
        case 19:
        case "end":
...
var searchUserInfo = exports.searchUserInfo = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var email, authenticatedUserId, authenticatedUser, user;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 7;
          return _userModel["default"].findById(authenticatedUserId);
        case 7:
        ...
        case 14:
          user = _context3.sent;
          // we replace finding the email by the company database 
        ...
        case 24:
          ...
          console.log("Error in searchUserInfo", _context3.t0.message);
        case 28:
        case "end":
  ...
  return function searchUserInfo(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var resetPassword = exports.resetPassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _req$body3, password, confirmPassword, user, hashedPassword;
